...
enum json_storage_type {
    ...
    JSON_ARRAY_INLINE_1,     /* Static 'elems' with exactly 1 element. */
    JSON_ARRAY_INLINE_2,     /* Static 'elems' with exactly 2 elements. */
    JSON_ARRAY_INLINE_3,     /* Static 'elems' with exactly 3 elements. */
};
